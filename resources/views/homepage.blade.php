...
<head>
    ...
    <style>
      @import url('https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap');
        ...
        /* Ensures content appears on top of the video */
        .overlay-content {
            position: relative;
            z-index: 1;
        ...
        /* Non-active state color */
        .navbar .nav-link {
            color: slategray; /* Non-active link color */
        }
...
<body>
    <header>
        <!-- Changed navbar background to white with text-dark for dark text -->
